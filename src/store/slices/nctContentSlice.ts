...
const initialState: NCTContentState = {
  fashion: {
    ...
    description: [
      ...
      "2002년 출시된 크록스는 독특한 실루엣과 가벼운 착화감으로 주목받았다.\n현대엔 자신만의 취향을 담은 지비츠 파츠를 더해 각자의 스타일을 완성할 수 있는 커스터마이징 신발로 진화했다. 레트로, Y2K, 놈코어 등 다양한 스타일과도 어우러지는 크록스는, 실용성과 재미, 그리고 과거의 향수를 모두 담고 있다.",
    ],
  },
  props: {
    image: [
  ...
  font: {
    ...
    description: [
      "90년대 청춘 영화처럼 VHS 시절 자막 연출, 교실과 여름 배경음도 삽입됨.",
      "20세기 중반 미국 만화와 할로윈에서 보던 시트 유령 연출.",
      "쨍한 색상을 배제하고 따뜻하고 바랜 느낌으로 필름 카메라 연출.",
      "1980~90년대 청춘 만화 속 여름풍경 같은 색감, 현실과 환상을 넘나드는 몽환적 연출.",
    ],
  },
  direction: {
    title: [
