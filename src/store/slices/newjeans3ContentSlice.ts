// src/slices/newjeans3ContentSlice.ts
...
interface NewJeans3ContentState {
  fashion: Fashion;
  props: Props;
  setSpace: SetSpace;
  direction: Direction;
...
const initialState: NewJeans3ContentState = {
  fashion: {
    title: [
      "[NewJeans 뉴진스 | Supernatural ] Look #1 - [Heaven by Marc Jacobs I FEEL ANGRY ZIP-UP]",
      "[NewJeans 뉴진스 | Supernatural ] Look #2 - [Hair Bandana Styling]",
      "[NewJeans 뉴진스 | Supernatural ] Look #3 - [1990s old school fashion]",
    ],
    image: [
      ["/fashion/newjeans3/1_1.png", "/fashion/newjeans3/1_2.png"],
      ["/fashion/newjeans3/2_1.png", "/fashion/newjeans3/2_2.png"],
      ["/fashion/newjeans3/3_1.png", "/fashion/newjeans3/3_2.png"],
    ],
    subTitle: [
    ...
    subDescription: [
      "Street wear, 2000s, Vintage graphic",
      "1990s, Old School, Hip-hop",
      "1990s, Old School, Hip-hop",
    ],
    timeStamp: ["(00:32 - 00:43)", "(01:29 - 01:35)", "(01:02 - 01:14)"],
    description: [
    ...
    image: [
      {
        ...
        detailImage: "/prop/newjeans3/detail/1.png",
        detailTitle: "ANNTIAN Hand knit tank top",
        detailDescription:
      ...
      },
      {
        ...
        detailImage: "/prop/newjeans3/detail/2.png",
        detailTitle: "Brain Dead 우먼스 크로쉐 칼라 KASS 셔츠",
        detailDescription:
          "서브컬처에서 영감을 받은 Brain Dead의 제품은 스케이트보딩, 포스트 펑크, 만화 등의 영역을 넘나들며 독특한 미적 감각을 표현한다. 로고와 파스티치한 그래픽이 특징이다.",
      },
      {
        src: "/prop/newjeans3/3.png",
        detailImage: "/prop/newjeans3/detail/3.png",
        detailTitle: "SCHISM INDUCING BANDANA HAT, BLACK",
        detailDescription:
          "페이즐리 패턴 반다나가 부착된 트러커캡 형태의 모자로, 큰 사이즈와 깊은 챙으로 트렌디한 스타일 연출이 가능하며, 후면에 금속 조절기(어저스터)가 있어 사이즈 조절이 용이하다.",
      },
      {
        src: "/prop/newjeans3/4.png",
        detailImage: "/prop/newjeans3/detail/4.png",
        detailTitle: "유민 하 Sticker-Sheet Beanie",
        detailDescription:
  ...
  setSpace: {
    title: [
      "90~2000년대 힙합/R&B 뮤직비디오 공간",
      "거대한 유리벽과 과도기적 공간",
      "공사 중인 건물 내부",
    ],
    image: [
      "/location/newjeans3/1.png",
      "/location/newjeans3/2.png",
      "/location/newjeans3/3.png",
    ],
    hoverImage: [
      "/location/newjeans3/1_hover.png",
      "/location/newjeans3/2_hover.png",
      "/location/newjeans3/3_hover.png",
    ],
    description: [
  ...
  direction: {
    ...
    image: [
      ["/direction/newjeans3/1.png", "/direction/newjeans3/1_2.png"],
      ["/direction/newjeans3/2.png", "/direction/newjeans3/2_2.png"],
      ["/direction/newjeans3/3.png", "/direction/newjeans3/3_2.png"],
    ],
    description: [
