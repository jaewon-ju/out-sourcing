      ...
      <div className="relative" style={{ ...containerStyle }}>
        ...
        <div className="w-full flex flex-col items-center">
          ...
          <div className="relative w-full flex flex-col items-center">
            ...
            {/* 홈 섹션: 메뉴 + 콘텐츠를 가로로 배치 */}
            <div className="relative w-full flex flex-row items-start justify-center gap-10 mt-10">
              {/* 왼쪽 콘텐츠 */}
              ...
              {/* 오른쪽 메뉴 */}
              <div className="sticky top-32 px-6 py-6">
                <div className="flex flex-col gap-0 bg-[#A2C7E9] rounded-md shadow-md">
