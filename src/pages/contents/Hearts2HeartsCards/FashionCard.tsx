...
import { Hearts2HeartsFashion } from "../../../store/slices/Hearts2Hearts";
          ...
          <div id="except-title" className="flex flex-row gap-[1.2vw]">
            ...
            <div className="flex flex-col pl-[1.2vw] pt-[1.2vw] pb-[1.2vw] w-1/2">
              <div className="flex flex-col items-start justify-center">
                ...
                />
                <p className="font-[AppleBold] font-bold text-left text-[1.1vw]">
                  {fashion.subTitle[0]}
                </p>
                <p className="text-xs mt-[1vh] text-[0.8vw]">
