...
import { Fashion } from "../../../store/slices/btsContentSlice";
    ...
    to-[#599adc]"
          ...
          <div id="except-title" className="flex flex-row gap-[1.2vw]">
            ...
            <div className="flex flex-col pl-[1.2vw] pt-[1.2vw] pb-[1.2vw] w-1/2">
              <div className="flex flex-col items-start justify-center">
                <img
                  src={fashion.image[2][0]}
                  alt={fashion.description[2]}
                  className="w-full h-auto object-cover mb-2"
                />
                <p className="font-[AppleNeoB] text-left text-[1.5vw]">
                  {fashion.subTitle[2]}
                ...
                <p className="text-xs mt-[0.25vh] text-[0.8vw]">
                  {fashion.subDescription[2]}
                </p>
                <p className="mt-[2vh] text-[1.2vw]">{fashion.timeStamp[2]}</p>
                <button
                  className="
                mb-[1vh] border 
                border-black px-[1vw] py-[0.5vh] mt-[1vh] text-[1.2vw]
            ...
            <div className="flex flex-col pr-[1.2vw] pt-[1.2vw] pb-[1.2vw] w-1/2">
              <div className="flex flex-col items-start justify-center">
                <img
                  src={fashion.image[2][1]}
                  alt={fashion.description[2]}
                  className="w-full h-auto object-cover mb-2"
                />
                <p className="text-[0.8vw] text-left whitespace-pre-line">
                  {fashion.description[2]}
                </p>
              </div>
            </div>
          </div>
